...
import hyperbolicOverthrall.actions.UncommonPowerAction;
...
public class DefaultUncommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = HyperbolicOverthrall.makeID(DefaultUncommonPower.class.getSimpleName());
