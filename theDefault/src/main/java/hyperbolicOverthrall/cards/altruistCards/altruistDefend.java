...
public class altruistDefend extends AbstractDynamicCard {
    public static final String ID = HyperbolicOverthrall.makeID(altruistDefend.class.getSimpleName());
