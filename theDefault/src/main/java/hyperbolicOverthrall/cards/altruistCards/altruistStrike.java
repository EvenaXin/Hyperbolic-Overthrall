...
public class altruistStrike extends AbstractDynamicCard {
    public static final String ID = HyperbolicOverthrall.makeID(altruistStrike.class.getSimpleName());
