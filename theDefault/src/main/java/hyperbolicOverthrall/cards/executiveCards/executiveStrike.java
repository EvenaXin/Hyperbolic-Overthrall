...
public class executiveStrike extends AbstractDynamicCard {
    public static final String ID = HyperbolicOverthrall.makeID(executiveStrike.class.getSimpleName());
