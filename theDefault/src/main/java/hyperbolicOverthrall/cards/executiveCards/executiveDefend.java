...
public class executiveDefend extends AbstractDynamicCard {
    public static final String ID = HyperbolicOverthrall.makeID(executiveDefend.class.getSimpleName());
