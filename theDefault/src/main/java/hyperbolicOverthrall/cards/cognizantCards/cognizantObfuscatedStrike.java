...
public class cognizantObfuscatedStrike extends AbstractDynamicCard {
    public static final String ID = HyperbolicOverthrall.makeID(cognizantObfuscatedStrike.class.getSimpleName());
    ...
    public cognizantObfuscatedStrike() {
    ...
    public void triggerWhenDrawn() {
        this.color = AbstractCard.CardColor.values()[AbstractDungeon.cardRandomRng.random(AbstractCard.CardColor.values().length - 1)];
    }
