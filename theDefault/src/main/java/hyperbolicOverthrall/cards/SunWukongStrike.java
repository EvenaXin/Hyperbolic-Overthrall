...
public class SunWukongStrike extends AbstractDynamicCard {
    public static final String ID = HyperbolicOverthrall.makeID(SunWukongStrike.class.getSimpleName());
