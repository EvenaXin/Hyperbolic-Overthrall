package hyperbolicOverthrall.orbs;
...
import static hyperbolicOverthrall.HyperbolicOverthrall.makeOrbPath;

public class DefaultOrb extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = HyperbolicOverthrall.makeID("DefaultOrb");
